...
import com.annam.annamownernew.Model.PlacePredictions;
import com.annam.annamownernew.Utilities.VolleyJSONRequest;
...
import com.annam.annamownernew.Adapter.AutoCompleteAdapter;
...
public class PickLocationActivity extends AppCompatActivity implements  Response.Listener<String>, Response.ErrorListener,  GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_main_location);
                ...
                if (Address.getText().length() > 3) {
                    ...
                    Runnable run = new Runnable() {
                        ...
                        public void run() {
                            ...
                            PickLocationHelper.volleyQueueInstance.cancelRequestInQueue(GETPLACESHIT);
                            ...
                            PickLocationHelper.volleyQueueInstance.addToRequestQueue(request);
    ...
    public String getPlaceAutoCompleteUrl(String input) {
        ...
        urlString.append("&key=" + "AIzaSyAxIYFy6VhyhkvuDrpvTL_XxOI25kgpSkw");
